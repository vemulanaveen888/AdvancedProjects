...
<p>
	<a href="/spring-mvc-theme/app/admissionForm.html?siteTheme=green">Green</a>
	<a href="/spring-mvc-theme/app/admissionForm.html?siteTheme=red">Red</a>
</p>

<a href="/spring-mvc-theme/app/admissionForm.html?sitelanguage=en">English</a>
<a href="/spring-mvc-theme/app/admissionForm.html?sitelanguage=fr">French</a>

	<h1>Student Admission Form</h1>
	<form:errors path="student.*"/>
	<form
		action="/spring-mvc-theme/app/submitAdmissionForm.html"
		method="POST">
		<table>
			<tr>
